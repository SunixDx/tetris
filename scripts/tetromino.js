...
class Tetromino {
    constructor(canvas, cellSize, shapes = [], initialPosition = new Position(),id = 1){
        this.canvas = canvas;
        ...
        this.position = new Position(this.initialPosition.row, this.initialPosition.column);
        this.id = id;
    }
